...
def fetch_local_businesses(lat, lon, radius=25000):
    ...
    headers = {'User-Agent': 'TheatreAnalyticsApp/1.9 (Local Testing)'}
...
if uploaded_file is not None:
    ...
    if st.session_state.processed_data is not None:
        ...
        # Create a volume column for processing percentages globally
        if qty_col != "None":
        ...
        with tab1:
            ...
            if not df_map.empty:
                ...
                # FIXED: Updated to universally supported px.scatter_mapbox
            ...
            with col_p2:
                ...
                # Formatted data table for absolute clarity
                st.dataframe(
            ...
            if venue_postcode:
                ...
                if v_lat and v_lon:
                    with st.spinner("Plotting routes and identifying local amenities..."):
                        ...
                        # FIXED: Updated map_style to universally supported 'light' to avoid PyDeck blank screens
