...
def fetch_local_businesses(lat, lon, radius=25000):
    ...
    out center;
    """
    headers = {'User-Agent': 'TheatreAnalyticsApp/2.1 (Local Testing)'}
    ...
    if st.session_state.processed_data is not None:
        ...
        with tab1:
            ...
            if not df_map.empty:
                ...
                # FIXED: Uses scatter_map which is compatible with Plotly 7.0+
                ...
                # FIXED: Uses map_style which is compatible with Plotly 7.0+
